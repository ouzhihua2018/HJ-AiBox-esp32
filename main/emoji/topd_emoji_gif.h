/**
 * @file topd_emoji_gif.h
 * @brief Topd机器人GIF表情资源组件
 *
 * 这个头文件声明了Topd机器人的6个GIF表情资源，用于在LVGL显示屏上显示动态表情。
 *
 * @version 1.0.2
 * @date 2025-08-20
 *
 ...
 * @return 版本字符串
 */
const char* topd_emoji_gif_get_version(void);

/**
 * @brief 获取支持的表情数量
 * @return 表情数量
 */
int topd_emoji_gif_get_count(void);
 ...
 */
const lv_image_dsc_t* topd_emoji_gif_get_by_name(const char* name);
