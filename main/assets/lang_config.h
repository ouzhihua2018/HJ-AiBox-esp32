...
namespace Lang {
    ...
    namespace Sounds {
        ...
        extern const char p3_activation_qrcode_start[] asm("_binary_activation_qrcode_p3_start");
        extern const char p3_activation_qrcode_end[] asm("_binary_activation_qrcode_p3_end");
        static const std::string_view P3_ACTIVATION_QRCODE {
