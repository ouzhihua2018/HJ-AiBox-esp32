...
#include "../topd-1.54tft-ml307-00/topd_lcd_display.h"
...
#include "../topd-1.54tft-ml307-00/power_manager.h"
...
private:
    ...
    void InitializeSt7789Display() {
        ...
        display_ = new TOPD_LcdDisplay(panel_io_, panel_, DISPLAY_WIDTH, DISPLAY_HEIGHT, DISPLAY_OFFSET_X, DISPLAY_OFFSET_Y, 
