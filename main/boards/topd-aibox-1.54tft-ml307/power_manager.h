...
#include <vector>
#include <functional>
#include <esp_log.h> //新增内容

#include <esp_timer.h>
#include <driver/gpio.h>
#include <esp_adc/adc_oneshot.h>
#include <driver/temperature_sensor.h> //增加温度传感器管理
...
private:
    ...
    std::function<void(float)> on_temperature_changed_; //新增温度变化
    ...
    float current_temperature_ = 0.0f;//温度检测
    int ticks_ = 0;
