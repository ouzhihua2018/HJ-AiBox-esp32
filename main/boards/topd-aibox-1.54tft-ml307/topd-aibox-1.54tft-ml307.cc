#include "dual_network_board.h"   // 增加双击boot键切换wifi或者ml307网络
...
#include "../topd-aibox-1.54tft-ml307/power_manager.h"
...
#define TAG "TOPD_AIBOX_1_54TFT_ML307"

LV_FONT_DECLARE(font_puhui_20_4);
LV_FONT_DECLARE(font_awesome_20_4);


class TOPD_AIBOX_1_54TFT_ML307 : public DualNetworkBoard {
private:
    Button boot_button_;
    ...
    static void HUMAN_SENSORTimerTask(void* arg) {
        TOPD_AIBOX_1_54TFT_ML307* board = static_cast<TOPD_AIBOX_1_54TFT_ML307*>(arg);
...
DECLARE_BOARD(TOPD_AIBOX_1_54TFT_ML307);
