...
#define VOLUME_UP_BUTTON_GPIO   GPIO_NUM_43
#define VOLUME_DOWN_BUTTON_GPIO GPIO_NUM_42

#define MOTOR_PWM2_GPIO   GPIO_NUM_NC
#define MOTOR_PWM_GPIO   GPIO_NUM_NC
#define MOTOR_ADC_GPIO   GPIO_NUM_4


#define ML307A_RX_PIN GPIO_NUM_3
#define ML307A_TX_PIN GPIO_NUM_5

#ifdef WBY_STYLE
#define RGB_B   GPIO_NUM_41
#define RGB_Y   GPIO_NUM_40
#define RGB_W   GPIO_NUM_38
#else
